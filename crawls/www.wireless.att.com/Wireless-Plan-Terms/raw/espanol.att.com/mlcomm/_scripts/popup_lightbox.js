...
// Apply the HTML markup into body tag
				...
				$('body').append('<div id="jquery-overlay"></div><div id="jquery-lightbox"><div id="lightbox-container-image-box" class="uverse-internet"><div id="lightbox-container-image" class="popup"><div class="ss-close"><img alt="Cerrar" src="/mlcomm/_images/template/btn_ss_close.jpg" /></div><div class="printable"   onclick="window.print()"><img alt="Imprimir" src="/mlcomm/_images/template/btn_popup_print.jpg" /></div><div class="clear"></div><div id="popup-functions" class="popup-box long"><p><strong>OFERTA DE PROGRAMACI&Oacute;N Y CR&Eacute;DITO EN LA FACTURA: SI AL FINAL DE LOS PER&Iacute;ODOS DE PROMOCI&Oacute;N, EL CLIENTE NO SE PONE EN CONTACTO CON DIRECTV PARA CAMBIAR EL SERVICIO, &Eacute;STE CONTINUAR&Aacute; PREST&Aacute;NDOSE AUTOM&Aacute;TICAMENTE SEG&Uacute;N LAS TARIFAS VIGENTES EN ESA FECHA, INCLUSO LA CUOTA DE ALQUILER</strong>. SHOWTIME gratis durante 3 meses, un ahorro de $38.97. HBO, Starz, SHOWTIME y Cinemax gratis durante 3 meses, un ahorro de $135. EXISTE UN L&Iacute;MITE DE UNA OFERTA DE PROGRAMACI&Oacute;N POR CUENTA. Nombres y precios de los paquetes en promoci&oacute;n: M&Aacute;S M&eacute;XICO por $29.99 al mes; &Oacute;PTIMO M&Aacute;S por $44.99 al mes; M&Aacute;S ULTRA por $59.99 al mes; LO M&Aacute;XIMO por $114.99 al mes. <strong>Precios incluyen un cr&eacute;dito instant&aacute;neo en la factura de $5 por el paquete de M&aacute;S M&eacute;XICO  o un cr&eacute;dito a la factura de $10 por 12 meses tras un reembolso por &oacute;PTIMO M&aacute;S ($15 d&oacute;lares por el paquete M&Aacute;S ULTRA o superior), m&aacute;s $5 d&oacute;lares adicionales con reembolso en l&iacute;nea y consentimiento de alertas de correo electr&oacute;nico de DIRECTV y un descuento instant&aacute;neo de $5 al combinar los servicios de AT&amp;T. Para ser elegible para recibir este descuento instant&aacute;neo de $5, debe combinar su facturaci&oacute;n de AT&amp;T con la de DIRECTV en su factura de AT&amp;T si tiene servicio local</strong>.</p><p><strong>Despu&eacute;s de la activaci&oacute;n del sistema DIRECTV, el cliente recibir&aacute; instrucciones de reembolso (se incluir&aacute;n en la carta de bienvenida de DIRECTV, en un env&iacute;o por correo por separado, o, si se encuentra en el estado de Nueva York, las recibir&aacute; del distribuidor al por menor) y debe cumplir con los t&eacute;rminos que aparezcan en dichas instrucciones. Para recibir el cr&eacute;dito total de $15 por &oacute;PTIMO M&aacute;S ($20 por M&Aacute;S ULTRA o superior), el cliente debe enviar el formulario de reembolso por Internet y aceptar recibir las alertas de correo electr&oacute;nico antes de que se procese el reembolso. El procesamiento del reembolso por Internet requiere una direcci&oacute;n de correo electr&oacute;nico v&aacute;lida</strong>. El reembolso se empezar&aacute; a aplicar a partir de las 6 u 8 semanas despu&eacute;s de recibido el formulario. La vigencia y duraci&oacute;n del precio promocional depende de la fecha del reembolso. </p><p><strong>SERVICIO DVR GRATIS</strong>: Se requiere la suscripci&oacute;n al paquete &Oacute;PTIMO M&Aacute;S o superior y al menos un receptor DVR y activaci&oacute;n del servicio DVR.</p><p><strong>OFERTA DE ALTA DEFINICI&Oacute;N GRATIS</strong>: Incluye acceso a canales en HD asociados con el paquete de programaci&oacute;n. La cantidad y el tipo de canales en HD var&iacute;an seg&uacute;n el paquete seleccionado.  Para reunir los requisitos de la oferta de alta definici&oacute;n gratis, el cliente debe activar y mantener el paquete LO MAXIMO. Tambi&eacute;n se requiere al menos un (1) receptor HD y la activaci&oacute;n del acceso a HD.  Para seguir reuniendo los requisitos, la cuenta debe estar al d&iacute;a con los pagos, seg&uacute;n lo determine DIRECTV a su entera discreci&oacute;n. La programaci&oacute;n y los precios pueden variar en algunos mercados.  </p><p><strong>"ACUERDO DE 2 A&Ntilde;OS: SI SE DA POR TERMINADO EL SERVICIO ANTES DE LA FECHA DE FINALIZACI&Oacute;N DEL CONTRATO, SE COBRAR&Aacute; UN CARGO POR CANCELACI&Oacute;N DE $20 POR CADA MES QUE FALTE PARA CUMPLIR EL PLAZO DEL CONTRATO</strong>. Se requiere la suscripci&oacute;n a cualquier paquete de programaci&oacute;n b&aacute;sico de DIRECTV por 24 meses consecutivos. Compromiso con el servicio de DVR ($ 7.00/mes.) Necesarios para DVR o HD DVR de arrendamiento. Cargo de acceso HD ($ 10.00/mes.) necesario para HD o el arrendamiento de HD DVR. Un receptor est&aacute;ndar sin cargo. La cuota de arrendamiento por los dos primeros receptores es de $6 al mes y $6 al mes por cada uno de los receptores adicionales. <strong>SI EL CLIENTE NO ACTIVA TODO EL EQUIPO DEL SISTEMA DIRECTV DE ACUERDO CON EL AP&Eacute;NDICE DEL ALQUILER DEL EQUIPO, ES POSIBLE QUE SE COBRE UN CARGO DE $150 POR CADA RECEPTOR QUE NO SE HAYA ACTIVADO.. TODO EL EQUIPO SE ALQUILA Y TIENE QUE DEVOLVERSE A DIRECTV AL CANCELAR EL SERVICIO O SE COBRAR&Aacute;N CARGOS POR EQUIPO NO DEVUELTO. VISITAR directv.com O LLAMAR AL 1-800-DIRECTV PARA OBTENER M&Aacute;S INFORMACI&Oacute;N. REEMBOLSO INSTANT&Aacute;NEO POR CAMBIO A HD o DVR</strong>: el reembolso instant&aacute;neo del equipo avanzado requiere la activaci&oacute;n de un paquete CHOICE XTRA o superior; M&Aacute;S ULTRA o superior (para un receptor DVR, se requiere el paquete OPTIMO MAS o superior); JadeWorld; o cualquier paquete de servicio internacional calificado, que incluya el paquete de programaci&oacute;n PREFERRED CHOICE (a $35.99 al mes). </p><p>La oferta del segundo receptor requiere la activaci&oacute;n de un HD DVR como la primera mejora gratis y suscripci&oacute;n al servicios Whole-Home DVR ($3/mes). Otras mejoras al receptor est&aacute;n disponible por un costo extra. INSTALACION: S&oacute;lo instalaci&oacute;n profesional est&aacute;ndar; la instalaci&oacute;n personalidad tiene un cargo adicional.</p><p>La programaci&oacute;n, el precio as&iacute; como los t&eacute;rminos y condiciones est&aacute;n sujetos a cambio en todo momento. Los precios son residenciales. No se incluyen los impuestos. La programaci&oacute;n de DIRECTV est&aacute; sujeta al contrato del cliente de DIRECTV. Se puede consultar una copia en directv.com/legal (en ingl&eacute;s), que tambi&eacute;n se env&iacute;a a los clientes el primer mes. AT&amp;T | DIRECTV es un servicio de marca compartida prestado por DIRECTV. AT&amp;T act&uacute;a como agente de ventas para DIRECTV, el cual es responsable de la prestaci&oacute;n del servicio. En caso de consultas con respecto al servicio, los clientes pueden llamar a DIRECTV al 1-800-531-5000  </p></div><div class="clear"></div> <div class="ss-close"><img alt="Cerrar" src="/mlcomm/_images/template/btn_ss_close.jpg" /></div><div class="printable"   onclick="window.print()"><img alt="Imprimir" src="/mlcomm/_images/template/btn_popup_print.jpg" /></div><div class="clear"></div></div></div>');	 								
				}	
